...
HD_PWD='C:/Users/invasion/XilinxProjects/i2s_test/i2s_test.runs/system_design_audio_formatter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_design_audio_formatter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_design_audio_formatter_0_0.tcl
